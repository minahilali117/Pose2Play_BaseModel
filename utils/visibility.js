/**
 * Visibility Check Utilities for Pose Detection
 * 
 * These functions help determine if body parts are visible in the camera frame.
 * Essential for reliable pose tracking and feedback.
 */
 ...
 * 
 * @returns {number} 1 if the body is fully in frame, 0 otherwise 
 */
 ...
 *
 * @returns {boolean} true if all landmarks are visible, false otherwise 
 */
